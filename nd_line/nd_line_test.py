...
for i,line in enumerate(fibers.keys()):
    ...
    nd=nd_line(fiberpoints)
    le = nd.length
    for n in range(int(100)):
        pts.append(nd.interp(n))
